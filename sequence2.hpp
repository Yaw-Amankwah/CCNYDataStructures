...
//      
//      Postcondition: A copy of source has been initialized into a new sequence. The new sequence's private member variables have been set to equal the source's private member variables.
//
